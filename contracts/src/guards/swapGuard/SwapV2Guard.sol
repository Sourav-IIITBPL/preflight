...
import {IUniswapV2Factory, IUniswapV2Pair, IUniswapV2Router} from "../../interfaces/ICamelotV2.sol";
import {IERC20Metadata} from "@openzeppelin/contracts/token/ERC20/extensions/IERC20Metadata.sol";
import {TokenGuard, TokenGuardResult} from "../lib/TokenGuard.sol";
/**
 * @title SwapV2Guard
 * @notice Pre-transaction guard for Camelot V2 swaps (a Uniswap V2 fork). Performs real-time pool state
...
contract SwapV2Guard is UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, AutomationCompatibleInterface {
    ...
    /// Minimum LP token total supply. pairs have 18 decimals .
    ...
    event SwapCheckPerformed(address indexed router, address[] indexed path, uint256 amountIn, GuardResultV2 indexed result);
...
// INTERNAL FUNCTIONS
    ...
    function _isSeverelyImbalanced(uint256 r0, uint256 r1) internal pure returns (bool) {
        ...
        return r0 * 10_000 < r1 * SEVERE_IMBALANCE_BPS
            || r1 * 10_000 < r0 * SEVERE_IMBALANCE_BPS;
    }
